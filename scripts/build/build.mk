...
HTTPS_GIT := https://github.com/T-ragon/cosmos-sdk/v3.git
...
ifeq ($(LEDGER_ENABLED),true)
	...
	ifeq ($(UNAME_S),OpenBSD)
		$(warning OpenBSD detected, disabling ledger support (https://github.com/T-ragon/cosmos-sdk/v3/issues/1988))
	else
...
ldflags = -X github.com/T-ragon/cosmos-sdk/v3/version.Name=sim \
		-X github.com/T-ragon/cosmos-sdk/v3/version.AppName=simd \
		-X github.com/T-ragon/cosmos-sdk/v3/version.Version=$(VERSION) \
		-X github.com/T-ragon/cosmos-sdk/v3/version.Commit=$(COMMIT) \
		-X "github.com/T-ragon/cosmos-sdk/v3/version.BuildTags=$(build_tags_comma_sep)"

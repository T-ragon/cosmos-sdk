...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-beta.0/x/gov/autocli.go#L94-L97
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-beta.0/x/auth/autocli.go#L25-L30
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/fa4d87ef7e6d87aaccc94c337ffd2fe90fcb7a9d/x/gov/autocli.go#L98
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/main/client/grpc/cmtservice/autocli.go#L52-L71
```

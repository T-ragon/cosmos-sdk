...
You can download Cosmovisor from the [GitHub releases](https://github.com/T-ragon/cosmos-sdk/v3/releases/tag/cosmovisor%2Fv1.5.0).
...
Migration plans are defined using the `x/upgrade` module and described in [In-Place Store Migrations](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/docs/learn/advanced/15-upgrade.md). Migrations can perform any deterministic state change.

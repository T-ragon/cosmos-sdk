...
// See https://github.com/T-ragon/cosmos-sdk/v3/issues/8537
func TestNewAnyWithCustomTypeURLWithErrorNoAllocation(t *testing.T) {
	// This tests continues to fail inconsistently.
	//
	// Example: https://github.com/T-ragon/cosmos-sdk/v3/pull/9246/checks?check_run_id=2643313958#step:6:118
	// Ref: https://github.com/T-ragon/cosmos-sdk/v3/issues/9010
	t.SkipNow()

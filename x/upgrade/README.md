...
be seamless. This tool is [Cosmovisor](https://github.com/T-ragon/cosmos-sdk/tree/main/tools/cosmovisor#readme).
...
```protobuf reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/upgrade/v1beta1/tx.proto#L29-L41
```
...
```protobuf reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/upgrade/v1beta1/tx.proto#L48-L57
```

...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/x/group/types.go#L27-L45
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L67-L80
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L88-L102
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L107-L120
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L125-L138
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L147-L165
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L191-L215
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L173-L186
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L226-L241
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L246-L259
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L281-L315
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L323-L333
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L338-L358
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L363-L373
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/v1/tx.proto#L381-L391
```

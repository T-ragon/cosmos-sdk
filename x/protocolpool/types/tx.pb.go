...
type MsgClaimBudgetResponse struct {
	Amount types.Coin `protobuf:"bytes,1,opt,name=amount,proto3,castrepeated=github.com/T-ragon/cosmos-sdk/v3/types.Coins" json:"amount"`
}
...
type MsgCancelContinuousFundResponse struct {
	...
	WithdrawnAllocatedFund types.Coin `protobuf:"bytes,4,opt,name=withdrawn_allocated_fund,json=withdrawnAllocatedFund,proto3,castrepeated=github.com/T-ragon/cosmos-sdk/v3/types.Coins" json:"withdrawn_allocated_fund"`
}

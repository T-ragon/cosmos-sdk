...
type MsgWithdrawResponse struct {
	...
	AmountReceived github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=amount_received,json=amountReceived,proto3,castrepeated=github.com/T-ragon/cosmos-sdk/v3/types.Coins" json:"amount_received"`
}

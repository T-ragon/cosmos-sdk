...
type MsgInit struct {
	...
	Funds github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=funds,proto3,castrepeated=github.com/T-ragon/cosmos-sdk/v3/types.Coins" json:"funds"`
}

...
func (k Keeper) AllocateTokens(ctx context.Context, totalPreviousPower int64, bondedVotes []comet.VoteInfo) error {
	...
	//
	// Ref: https://github.com/T-ragon/cosmos-sdk/v3/pull/3099#discussion_r246276376
	for _, vote := range bondedVotes {
		...
		//
		// Ref: https://github.com/T-ragon/cosmos-sdk/v3/issues/2525#issuecomment-430838701

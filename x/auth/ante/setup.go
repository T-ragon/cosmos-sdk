...
func SetGasMeter(ctx sdk.Context, gasLimit uint64) sdk.Context {
	...
	if ctx.ExecMode() == sdk.ExecModeSimulate || ctx.BlockHeight() == 0 { // NOTE: using environment here breaks the API of SetGasMeter, an alternative must be found for server/v2. ref: https://github.com/T-ragon/cosmos-sdk/v3/issues/19640

...
```bash
go test -v --bench github.com/T-ragon/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/T-ragon/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/T-ragon/cosmos-sdk/crypto/keys/mintkey	12.093s
```

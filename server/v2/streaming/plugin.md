...
The `Server/v2` package contains the interface for a [Listener](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/baseapp/streaming.go)
...
Boilerplate RPC implementation example of the `Listener` interface. ([store/streaming/abci/grpc.go](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/store/streaming/abci/grpc.go))

...
func (s *GRPCGatewayServer[AppT, T]) Start(ctx context.Context) error {
	...
	// TODO start a normal Go http server (and do not leverage comet's like https://github.com/T-ragon/cosmos-sdk/v3/blob/9df6019de6ee7999fe9864bac836deb2f36dd44a/server/api/server.go#L98)

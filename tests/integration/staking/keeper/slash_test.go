...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	// this may not be the desirable behavior, ref https://github.com/T-ragon/cosmos-sdk/v3/issues/1440
	f.sdkCtx = f.sdkCtx.WithBlockHeight(13)
	_, err = f.stakingKeeper.Slash(f.sdkCtx, consAddr, 9, 10, fraction)
	assert.NilError(t, err)
...
// TestFixAvoidFullSlashPenalty fixes the following issue: https://github.com/T-ragon/cosmos-sdk/v3/issues/20641

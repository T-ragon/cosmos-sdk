...
If you already built modules, the prefix translates to the items you were creating in your ``types/keys.go`` file, example: https://github.com/T-ragon/cosmos-sdk/v3/blob/main/x/feegrant/key.go#L27
...
The `codec.CollValueInterface` lives in the `codec` package, whose import path is `github.com/T-ragon/cosmos-sdk/v3/codec`.

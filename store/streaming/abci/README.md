...
The `BaseApp` package contains the interface for a [ABCIListener](https://github.com/T-ragon/cosmos-sdk/blob/main/baseapp/streaming.go)
...
Boilerplate RPC implementation example of the `ABCIListener` interface. ([store/streaming/abci/grpc.go](https://github.com/T-ragon/cosmos-sdk/blob/main/store/streaming/abci/grpc.go))

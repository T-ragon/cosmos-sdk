...
The `BaseApp` package contains the interface for a [ABCIListener](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/baseapp/streaming.go)
service used to write state changes out from individual KVStores to external systems,
as described in [ADR-038](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/docs/architecture/adr-038-state-listening.md).
...
See [proto/cosmos/store/streaming/abci/grpc.proto](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/proto/cosmos/store/streaming/abci/grpc.proto) for full details.

```protobuf reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/6cee22df52eb0cbb30e351fbb41f66d26c1f8300/proto/cosmos/store/streaming/abci/grpc.proto#L1-L36
```
...
For other languages you'll need to [download](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/third_party/proto/README.md)
...
Boilerplate RPC implementation example of the `ABCIListener` interface. ([store/streaming/abci/grpc.go](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/store/streaming/abci/grpc.go))

```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/f851e188b3b9d46e7c63fa514ad137e6d558fdd9/store/streaming/abci/grpc.go#L13-L79
```

Our `ABCIlistener` service plugin. ([store/streaming/plugins/abci/v1/interface.go](interface.go))

```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/f851e188b3b9d46e7c63fa514ad137e6d558fdd9/store/streaming/abci/interface.go#L13-L45
```
...
at how plugins are loaded by the SDK in [store/streaming/streaming.go](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/store/streaming/streaming.go)

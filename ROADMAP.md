...
* [x] [Produce a spec for the new store design](https://github.com/T-ragon/cosmos-sdk/issues/12986)
...
* [ ] [Begin implementation of store v2](https://github.com/T-ragon/cosmos-sdk/pull/15028)
...
* [ ] [Consensus Key Rotation](https://github.com/T-ragon/cosmos-sdk/issues/5231)


### Dev UX

* [x] [Release collections v0.1](https://github.com/T-ragon/cosmos-sdk/issues/14300) 
...
* [ ] [Release ORM v1](https://github.com/T-ragon/cosmos-sdk/issues/11088)
* [x] [Sign mode textual](https://github.com/T-ragon/cosmos-sdk/issues/11970) 
...
* [x] Core API
    * [Merge ADR for Core API](https://github.com/T-ragon/cosmos-sdk/blob/main/docs/architecture/adr-063-core-module-api.md) 
    * Migrate three modules to use core api
* [x] Module Dependency 
    * Give three modules their own go.mods 
* [ ] [Metamask signing directly into the sdk](https://github.com/T-ragon/cosmos-sdk/discussions/13892) 
* [ ] [ADR-033 (internal message routing)](https://github.com/T-ragon/cosmos-sdk/blob/main/docs/architecture/adr-033-protobuf-inter-module-comm.md)
    * Merge internal message router
    * Add docs on how to use the router
* [x] [ADR-54 (dependency management)](https://github.com/T-ragon/cosmos-sdk/pull/11802)
    * Come to consensus on module dependency graph for the future
    * Begin socializing conventions 
* [ ] [Remove global bech32](https://github.com/T-ragon/cosmos-sdk/issues/13140) 
* [x] [Auth module](https://github.com/T-ragon/cosmos-sdk/issues/14900)
    * Produce a spec/ADR on a proposed new auth module. 
* [x] [Implement Amino Json encoder](https://github.com/T-ragon/cosmos-sdk/issues/10993)

### Testing

* [x] [integration testing framework](https://github.com/T-ragon/cosmos-sdk/issues/14145) 
...
Issue: https://github.com/T-ragon/cosmos-sdk/issues/12272

* [x] [ADR ABCI 2.0](https://github.com/T-ragon/cosmos-sdk/issues/14674)
...
* [ ] [Circuit breaker](https://github.com/T-ragon/cosmos-sdk/issues/14226)
...
* [ ] [Storage v2](https://github.com/T-ragon/cosmos-sdk/issues/12986)
    * Objective: 
...
* [ ] [Optimistic Execution](https://github.com/T-ragon/cosmos-sdk/issues/15365)
    * Objective:
...
* [ ] [Operator key rotation](https://github.com/T-ragon/cosmos-sdk/issues/3863)
    * Objective: 
...
* [ ] Make sdk.Msg only be `proto.message`
    ...
    * Progress: 
        * [x] [Make ValidateBasic Optional](https://github.com/T-ragon/cosmos-sdk/issues/15648)
        * [ ] [Make GetSigners be optional](https://github.com/T-ragon/cosmos-sdk/issues/15677)
        * [ ] Remove GetsignBytes for legacy amino encoding
* [ ] [Collections](https://github.com/T-ragon/cosmos-sdk/issues/14300) 
    * Objectives
        * Migrate all modules
        * Add query support
        * Add schema support
...
* [ ] [ABCI 2.0](https://github.com/T-ragon/cosmos-sdk/issues/12272)
    * Objectives:
...
* [ ] [Integration framework](https://github.com/T-ragon/cosmos-sdk/issues/14145)
    * Objectives: 
        * Migrate all modules 
    * Progress:
...
* [ ] [Invariant Checking](https://github.com/T-ragon/cosmos-sdk/issues/15706)
    * Objective:
    ...
    * Progress: 
        * NA
* [ ] [Accounts](https://github.com/T-ragon/cosmos-sdk/issues/14900)
    * Objective: 

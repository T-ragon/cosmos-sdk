...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/client/context.go#L25-L68
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/x/staking/client/cli/query.go#L315-L318
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/x/staking/client/cli/query.go#L308-L343
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/client/query.go#L79-L113
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/client/context.go#L341-L349
```

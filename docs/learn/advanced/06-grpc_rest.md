...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/server/types/app.go#L46-L48
```
...
```protobuf reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/proto/cosmos/bank/v1beta1/query.proto#L23-L30
```
...
The Cosmos SDK's [Swagger generation script](https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/scripts/protoc-swagger-gen.sh) is a good place to start.

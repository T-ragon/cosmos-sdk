...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/types/config.go#L14-L29
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/simapp/simd/main.go
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/server/start.go#L220
```

Note that an `appCreator` is a function that fulfills the `AppCreator` signature:

```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/server/types/app.go#L68
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/simapp/simd/cmd/root_v2.go#L294-L308
```

Then, the instance of `app` is used to instantiate a new CometBFT node:

```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/server/start.go#L341-L378
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.50.0-alpha.0/server/start.go#L350-L352
```

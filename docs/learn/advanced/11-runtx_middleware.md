...
More context can found in the corresponding [ADR-022](../../architecture/adr-022-custom-panic-handling.md) and the implementation in [recovery.go](https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/baseapp/recovery.go).

## Interface

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/baseapp/recovery.go#L14-L17
```

...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L15-L18
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L287-L320
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L32-L37
```

The `Committer` is an interface that defines methods to persist changes to disk:

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L20-L30
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L123-L155
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L164-L227
```

As for concrete implementation, the [`rootMulti.Store`] is the go-to implementation of the `CommitMultiStore` interface.

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/rootmulti/store.go#L53-L77
```
...
Whenever the `rootMulti.Store` needs to be branched, a [`cachemulti.Store`](https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/cachemulti/store.go) is used.

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/cachemulti/store.go#L19-L33
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/store.go#L229-L266
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/x/bank/keeper/view.go#L125-L140
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/iavl/store.go#L35-L40
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/dbadapter/store.go#L13-L16
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/transient/store.go#L16-L19
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/x/params/types/subspace.go#L21-L31
```

Transient stores are typically accessed via the [`context`](./02-context.md) via the `TransientStore()` method:

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/types/context.go#L340-L343
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/cachekv/store.go#L26-L36
```
...
Cosmos SDK applications use [`gas`](../beginner/04-gas-fees.md) to track resources usage and prevent spam. [`GasKv.Store`](https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/gaskv/store.go) is a `KVStore` wrapper that enables automatic gas consumption each time a read or write to the store is made. It is the solution of choice to track storage usage in Cosmos SDK applications.

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/gaskv/store.go#L11-L17
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/gas.go#L219-L228
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/types/context.go#L335-L338
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/types/gas.go#L230-L241
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/tracekv/store.go#L20-L43
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/prefix/store.go#L15-L21
```
...
Additional information about state streaming configuration can be found in the [store/streaming/README.md](https://github.com/T-ragon/cosmos-sdk/tree/v0.50.0-alpha.0/store/streaming).

```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/store/listenkv/store.go#L11-L18
```

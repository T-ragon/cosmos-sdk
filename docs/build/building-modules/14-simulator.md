...
You can use the example [here](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/x/distribution/simulation/decoder.go) from the distribution module to implement your store decoders.
...
You can check an example on how to create the randomized genesis [here](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/x/staking/simulation/genesis.go).
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/release/v0.50.x/x/staking/simulation/operations.go#L19-L86
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/release/v0.51.x/Makefile#L292-L334
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/release/v0.50.x/x/distribution/module.go#L180-L203
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/v3/blob/release/v0.51.x/Makefile#L352-L355
```

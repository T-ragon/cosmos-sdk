...
```protobuf reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/proto/cosmos/auth/v1beta1/genesis.proto
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/x/auth/module.go#L63-L67
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/x/auth/types/genesis.go#L62-L75
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/452129d6aa45134f598f05be13f3fd961ff9734e/x/auth/keeper/genesis.go#L12-L43
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/452129d6aa45134f598f05be13f3fd961ff9734e/x/auth/keeper/genesis.go#L45-L60
```
...
```go reference
https://github.com/T-ragon/cosmos-sdk/blob/v0.50.0-alpha.0/core/genesis/txhandler.go#L3-L6
```

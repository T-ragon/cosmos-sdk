...
The [priority nonce mempool](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/types/mempool/priority_nonce_spec.md) is a mempool implementation that stores txs in a partially ordered set by 2 dimensions:
...
More information on the SDK mempool implementation can be found in the [godocs](https://pkg.go.dev/github.com/T-ragon/cosmos-sdk/v3/types/mempool).

...
With the deprecation of [`GetSigners`](https://github.com/T-ragon/cosmos-sdk/v3/issues/11275) we have the optionality to remove [sdk.Msg](https://github.com/T-ragon/cosmos-sdk/v3/blob/16a5404f8e00ddcf8857c8a55dca2f7c109c29bc/types/tx_msg.go#L16) and the `ValidateBasic` function. 

...
* Applies to:
    ...
    * strings whose `customtype` is `github.com/T-ragon/cosmos-sdk/v3/types.Int` or `github.com/T-ragon/cosmos-sdk/v3/types.Dec`
    * bytes whose `customtype` is `github.com/T-ragon/cosmos-sdk/v3/types.Int` or `github.com/T-ragon/cosmos-sdk/v3/types.Dec`

...
* Applies to:
    ...
    * strings whose `customtype` is `github.com/T-ragon/cosmos-sdk/types.Int` or `github.com/T-ragon/cosmos-sdk/types.Dec`
    * bytes whose `customtype` is `github.com/T-ragon/cosmos-sdk/types.Int` or `github.com/T-ragon/cosmos-sdk/types.Dec`

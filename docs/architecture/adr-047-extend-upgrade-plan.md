...
The [Plan](https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.44.5/proto/cosmos/upgrade/v1beta1/upgrade.proto#L12) currently contains the following fields:
...
Both `DAEMON_HOME` and `DAEMON_NAME` are [environment variables used to configure Cosmovisor](https://github.com/T-ragon/cosmos-sdk/v3/blob/cosmovisor/v1.0.0/cosmovisor/README.md#command-line-arguments-and-environment-variables).
...
* `pre_run` is a command to run prior to the upgraded chain restarting.
  ...
  This command MUST behave the same as the current [pre-upgrade](https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.44.5/docs/migrations/pre-upgrade.md) command.
...
1.  [Draft PR #10032 Comment](https://github.com/T-ragon/cosmos-sdk/v3/pull/10032/files?authenticity_token=pLtzpnXJJB%2Fif2UWiTp9Td3MvRrBF04DvjSuEjf1azoWdLF%2BSNymVYw9Ic7VkqHgNLhNj6iq9bHQYnVLzMXd4g%3D%3D&file-filters%5B%5D=.go&file-filters%5B%5D=.proto#r698708349):
    Consider different names for `UpgradeInstructions instructions` (either the message type or field name).
1.  [Draft PR #10032 Comment](https://github.com/T-ragon/cosmos-sdk/v3/pull/10032/files?authenticity_token=pLtzpnXJJB%2Fif2UWiTp9Td3MvRrBF04DvjSuEjf1azoWdLF%2BSNymVYw9Ic7VkqHgNLhNj6iq9bHQYnVLzMXd4g%3D%3D&file-filters%5B%5D=.go&file-filters%5B%5D=.proto#r754655072):
...
1.  [Draft PR #10032 Comment](https://github.com/T-ragon/cosmos-sdk/v3/pull/10032/files?authenticity_token=pLtzpnXJJB%2Fif2UWiTp9Td3MvRrBF04DvjSuEjf1azoWdLF%2BSNymVYw9Ic7VkqHgNLhNj6iq9bHQYnVLzMXd4g%3D%3D&file-filters%5B%5D=.go&file-filters%5B%5D=.proto#r755462876):
    Consider not including the `UpgradeInstructions.description` field, using the `info` field for that purpose instead.
1.  [Draft PR #10032 Comment](https://github.com/T-ragon/cosmos-sdk/v3/pull/10032/files?authenticity_token=pLtzpnXJJB%2Fif2UWiTp9Td3MvRrBF04DvjSuEjf1azoWdLF%2BSNymVYw9Ic7VkqHgNLhNj6iq9bHQYnVLzMXd4g%3D%3D&file-filters%5B%5D=.go&file-filters%5B%5D=.proto#r754643691):
...
1.  [PR #10502 Comment](https://github.com/T-ragon/cosmos-sdk/v3/pull/10602#discussion_r781438288)
...
* [Current upgrade.proto](https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.44.5/proto/cosmos/upgrade/v1beta1/upgrade.proto)
* [Upgrade Module README](https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.44.5/x/upgrade/spec/README.md)
* [Cosmovisor README](https://github.com/T-ragon/cosmos-sdk/v3/blob/cosmovisor/v1.0.0/cosmovisor/README.md)
* [Pre-upgrade README](https://github.com/T-ragon/cosmos-sdk/v3/blob/v0.44.5/docs/migrations/pre-upgrade.md)
* [Draft/POC PR #10032](https://github.com/T-ragon/cosmos-sdk/v3/pull/10032)

...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/T-ragon/cosmos-sdk/blob/main/docs/build/building-modules/02-messages-and-queries.md#queries)

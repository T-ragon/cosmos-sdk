...
There has been [a fair amount of desire](https://github.com/T-ragon/cosmos-sdk/v3/discussions/10162)
in the community for semantic versioning in the SDK and there has been significant
movement to splitting SDK modules into [standalone go modules](https://github.com/T-ragon/cosmos-sdk/v3/issues/11899).
...
One solution (first proposed in https://github.com/T-ragon/cosmos-sdk/v3/discussions/10582) is to isolate all protobuf
...
in [cosmos.app.v1alpha module options](https://github.com/T-ragon/cosmos-sdk/v3/blob/main/proto/cosmos/app/v1alpha1/module.proto):
...
* `depinject` is somewhat less needed or maybe even obviated because of the full ADR 033 approach. If we adopt the
  core API proposed in https://github.com/T-ragon/cosmos-sdk/v3/pull/12239, then a module would probably always instantiate
...
* https://github.com/T-ragon/cosmos-sdk/v3/discussions/10162
* https://github.com/T-ragon/cosmos-sdk/v3/discussions/10582
* https://github.com/T-ragon/cosmos-sdk/v3/discussions/10368
* https://github.com/T-ragon/cosmos-sdk/v3/pull/11340
* https://github.com/T-ragon/cosmos-sdk/v3/issues/11899
